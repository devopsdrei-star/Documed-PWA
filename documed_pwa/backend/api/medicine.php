...
if ($action === 'suggestions') {
    // Local suggestion/decision logic has been deprecated.
    // Use the AI aggregate endpoint instead: backend/api/deepseek_analysis.php?action=analyze_aggregate
    echo json_encode([
        'success' => true,
        'deprecated' => true,
        'message' => 'Local suggestions removed. Use AI aggregate endpoint at ../deepseek_analysis.php?action=analyze_aggregate',
        'suggestions' => [],
        'narrative' => 'Local suggestion engine removed. Admin UI should call AI aggregate endpoint.'
    ]);
    exit;
}
